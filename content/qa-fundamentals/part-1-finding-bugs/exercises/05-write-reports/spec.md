...
## Bug Descriptions → Expected Severity Mapping (for reference)

| Description | Suggested Severity | Suggested Priority |
|-------------|-------------------|--------------------|
| Bio field doesn't save | Medium | Medium |
| Search shows wrong category | High | High |
| Password reset email not arriving | High | High |
